...
#w = r'/DS/Datasets/CH_custom/VOC/Human/Himant_body_parts/trained_weights/onnx/yolov5s_fp32.onnx'
...
if __name__ == '__main__':
    yolov7_detector = YOLOv7(w, cnames, conf_thres=0.2, iou_thres=0.45)
